                    ...
                    <h3 class="text-3xl mb-3"><b>Tambahkan Pengunjung Tamu</b></h3>
                        ...
                        <div class="mb-4">
                            ...
                            <QuillEditor theme="snow"
                                            ...
                                            v-model:content="form.kesan"
                                            style="height: 220px;"
                                            contentType="html" name="kesan" id="kesan" />
                            <span class="text-red-500 text-xs">{{ form.errors.kesan }}</span>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <QuillEditor theme="snow"
                                            :toolbar="[['bold', 'italic'], [{ 'header': 1 }], [{ 'list': 'ordered'}, { 'list': 'bullet' }]]"
                                            v-model:content="form.pesan"
                                            style="height: 220px;"
                                            contentType="html" name="pesan" id="pesan" />
                            <span class="text-red-500 text-xs">{{ form.errors.pesan }}</span>
                        </div>
