                            ...
                            <ul class="space-y-2 pb-2">
                                ...
                                <li>
                                    ...
                                    >
                                        ...
                                        <span class="ml-3">Kategori Buku</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link
                                    ...
                                    >
                                        ...
                                        <span class="ml-3">Pengarang Buku</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link
                                    ...
                                    >
                                        ...
                                        <span class="ml-3">Lokasi Rak</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link
                                ...
                                <li>
                                    ...
                                    >
                                        ...
                                        <span class="ml-3">Pinjaman Buku Guru</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link
                                    ...
                                    >
                                        ...
                                        <span class="ml-3">Pinjaman Buku Murid</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link
                                        :href="route('book.visitorGuest')"
                                        class="text-base font-normal rounded-lg flex items-center p-2 group"
                                        :class="{
                                            active: $page.url.startsWith(
                                                '/admin/visitor/book/guest'
                                            ),
                                        }"
                                    >
                                        <svg
                                        ...
                                        <span class="ml-3">Buku Pengunjung Tamu</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link
                                        :href="route('book.visitorTeacher')"
                                        class="text-base font-normal rounded-lg flex items-center p-2 group"
                                        :class="{
                                            active: $page.url.startsWith(
                                                '/admin/visitor/book/teacher'
                                            ),
                                        }"
                                    >
                                        <svg
                                        ...
                                        <span class="ml-3">Buku Pengunjung Guru</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link
                                        :href="route('book.visitorStudent')"
                                        class="text-base font-normal rounded-lg flex items-center p-2 group"
                                        :class="{
                                            active: $page.url.startsWith(
                                                '/admin/visitor/book/student'
                                            ),
                                        }"
                                    >
                                        <svg
                                        ...
                                        <span class="ml-3">Buku Pengunjung Murid</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link
